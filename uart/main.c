...
#define POSTDIV1 6
#define POSTDIV2 2
#define CPUFREQ 125000000 //in this setup should be between 63 and 133 MHz
...
void prog(){
    ...
    REG(RESETS_BASE + RESETS_RESET_OFFSET + REG_ALIAS_CLR_BITS) = RESETS_RESET_IO_BANK0_BITS | RESETS_RESET_PADS_BANK0_BITS | RESETS_RESET_PLL_SYS_BITS;
    while(~(REG(RESETS_BASE + RESETS_RESET_DONE_OFFSET)) & (RESETS_RESET_DONE_IO_BANK0_BITS | RESETS_RESET_DONE_PADS_BANK0_BITS | RESETS_RESET_DONE_PLL_SYS_BITS));
